...
4) Использовать для запросов "секретный" статический ключ:
...
DEM-файл включён в репозиторий: `data/dem/crimea_south.tif`. Подробнее: [data/README.md](data/README.md).